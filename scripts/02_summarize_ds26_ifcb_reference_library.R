...
pin <- utils::read.csv("metadata/stage2_ds26_ifcb_reference_active_run.csv",
                       stringsAsFactors = FALSE, check.names = FALSE)
manifest <- utils::read.csv("metadata/stage2_ds26_ifcb_reference_acquisition_manifest.csv",
                            stringsAsFactors = FALSE, check.names = FALSE)
...
write_csv_atomic(summary, "metadata/stage2_ds26_ifcb_reference_summary.csv")
