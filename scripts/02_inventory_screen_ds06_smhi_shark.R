...
pin_path <- "metadata/stage2_ds06_smhi_shark_active_run.csv"
manifest_path <- "metadata/stage2_ds06_smhi_shark_acquisition_manifest.csv"
...
inventory_path <- "metadata/stage2_ds06_smhi_shark_variable_inventory.csv"
summary_path <- "metadata/stage2_ds06_smhi_shark_package_summary.csv"
...
registry_path <- "metadata/stage2_ds06_smhi_shark_output_registry.csv"
