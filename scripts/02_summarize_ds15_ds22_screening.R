...
write_csv_atomic(ds15, "metadata/stage2_ds15_emodnet_erddap_screening_summary.csv")
...
write_csv_atomic(ds22, "metadata/stage2_ds22_ices_figshare_screening_summary.csv")
