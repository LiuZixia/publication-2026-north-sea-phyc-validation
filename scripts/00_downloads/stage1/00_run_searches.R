...
utils::write.csv(completed, "metadata/stage1/search/active_runs.csv", row.names = FALSE)
message("All Stage 1 searches completed and metadata/stage1/search/active_runs.csv was pinned.")
