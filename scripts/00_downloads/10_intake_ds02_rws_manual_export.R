...
tracked_manifest_path <- "metadata/stage2_ds02_rws_manual_export_acquisition_manifest.csv"
tracked_inventory_path <- "metadata/stage2_ds02_rws_manual_export_file_inventory.csv"
tracked_summary_path <- "metadata/stage2_ds02_rws_manual_export_intake_summary.csv"
tracked_pin_path <- "metadata/stage2_ds02_rws_manual_export_active_run.csv"
