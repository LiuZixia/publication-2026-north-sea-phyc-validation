...
write_tracked_pins <- function(directory, manifest) {
  ...
  write_csv_atomic(manifest, "metadata/stage2/acquisition/ds02_rws_catalogue_acquisition_manifest.csv")
  write_csv_atomic(pin, "metadata/stage2/acquisition/ds02_rws_catalogue_active_run.csv")
}
