...
write_tracked <- function(directory) {
  ...
  write_csv_atomic(diagnosis, "metadata/stage2/acquisition/ds02_rws_v3_access_diagnosis.csv")
  write_csv_atomic(pin, "metadata/stage2/acquisition/ds02_rws_v3_access_active_run.csv")
}
