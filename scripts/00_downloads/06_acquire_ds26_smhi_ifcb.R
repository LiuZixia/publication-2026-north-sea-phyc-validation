...
write_tracked_pins <- function(directory, manifest) {
  ...
  write_csv_atomic(manifest, "metadata/stage2_ds26_smhi_ifcb_acquisition_manifest.csv")
  write_csv_atomic(pin, "metadata/stage2_ds26_smhi_ifcb_active_run.csv")
  figshare_inventory <- utils::read.csv(file.path(directory, "figshare_file_inventory.csv"),
                                        stringsAsFactors = FALSE, check.names = FALSE)
  write_csv_atomic(figshare_inventory, "metadata/stage2_ds26_smhi_ifcb_figshare_file_inventory.csv")
}
