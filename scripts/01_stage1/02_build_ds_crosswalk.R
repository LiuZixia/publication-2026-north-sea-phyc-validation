...
utils::write.csv(crosswalk, "metadata/stage1/qualification/ds_crosswalk.csv", row.names = FALSE, na = "")
...
utils::write.csv(shortlist, "metadata/stage1/qualification/acquisition_shortlist.csv", row.names = FALSE, na = "")
...
utils::write.csv(unavailable, "metadata/stage1/qualification/unavailable_candidates.csv", row.names = FALSE, na = "")
