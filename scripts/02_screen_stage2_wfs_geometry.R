...
pin <- utils::read.csv("metadata/stage2_emodnet_wfs_active_run.csv", stringsAsFactors = FALSE,
                       check.names = FALSE)
...
initial_queue <- utils::read.csv("metadata/stage2_wfs_geometry_queue.csv", stringsAsFactors = FALSE,
...
write_csv_atomic(evidence, "metadata/stage2_emodnet_wfs_geometry_evidence.csv")
