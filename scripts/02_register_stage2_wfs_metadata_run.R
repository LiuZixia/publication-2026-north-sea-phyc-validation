...
if (length(arguments) != 1L) {
  stop("Usage: Rscript scripts/02_register_stage2_wfs_metadata_run.R data/raw/stage2/emodnet_wfs_survivor_metadata/<UTC>", call. = FALSE)
}
...
write_csv_atomic(pin, "metadata/stage2_emodnet_wfs_metadata_active_run.csv")
