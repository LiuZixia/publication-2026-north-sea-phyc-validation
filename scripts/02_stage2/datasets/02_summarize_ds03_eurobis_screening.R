...
loc_file <- "metadata/stage2/screening/ds03_eurobis_location_summary.csv"
...
write_csv_atomic(summary, "metadata/stage2/screening/ds03_eurobis_screening_summary.csv")
