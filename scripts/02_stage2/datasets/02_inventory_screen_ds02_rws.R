...
pin_path <- "metadata/stage2/acquisition/ds02_rws_manual_export_active_run.csv"
manifest_path <- "metadata/stage2/acquisition/ds02_rws_manual_export_acquisition_manifest.csv"
...
inventory_path <- "metadata/stage2/screening/ds02_rws_variable_inventory.csv"
summary_path <- "metadata/stage2/screening/ds02_rws_package_summary.csv"
...
registry_path <- "metadata/stage2/screening/ds02_rws_output_registry.csv"
