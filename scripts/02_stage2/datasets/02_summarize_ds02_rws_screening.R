...
packages <- utils::read.csv("metadata/stage2/screening/ds02_rws_package_summary.csv",
                            stringsAsFactors = FALSE, check.names = FALSE)
duplicate_summary <- utils::read.csv(
  "metadata/stage2/screening/ds02_rws_duplicate_resolution_summary.csv",
...
duplicate_registry <- utils::read.csv(
  "metadata/stage2/screening/ds02_rws_duplicate_resolution_registry.csv",
  stringsAsFactors = FALSE,
  check.names = FALSE
)
...
duplicate_registry <- relocate_stage2_registry_paths(
  duplicate_registry, "metadata/stage2/screening/ds02_rws_duplicate_resolution_registry.csv"
)
...
write_csv_atomic(summary, "metadata/stage2/screening/ds02_rws_screening_summary.csv")
