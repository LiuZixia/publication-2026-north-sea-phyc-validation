...
loc_file <- "metadata/stage2/screening/ds24_figshare_location_summary.csv"
...
write_csv_atomic(summary, "metadata/stage2/screening/ds24_figshare_screening_summary.csv")
