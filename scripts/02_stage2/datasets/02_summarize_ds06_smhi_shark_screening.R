...
manifest <- utils::read.csv("metadata/stage2/acquisition/ds06_smhi_shark_acquisition_manifest.csv",
                            stringsAsFactors = FALSE, check.names = FALSE)
packages <- utils::read.csv("metadata/stage2/screening/ds06_smhi_shark_package_summary.csv",
                            stringsAsFactors = FALSE, check.names = FALSE)
duplicate_summary <- utils::read.csv(
  "metadata/stage2/screening/ds06_smhi_shark_duplicate_resolution_summary.csv",
  stringsAsFactors = FALSE,
  check.names = FALSE
)
base_registry <- utils::read.csv("metadata/stage2/screening/ds06_smhi_shark_output_registry.csv",
                                 stringsAsFactors = FALSE, check.names = FALSE)
duplicate_registry <- utils::read.csv(
  "metadata/stage2/screening/ds06_smhi_shark_duplicate_resolution_registry.csv",
  stringsAsFactors = FALSE,
  check.names = FALSE
)
base_registry <- relocate_stage2_registry_paths(
  base_registry, "metadata/stage2/screening/ds06_smhi_shark_output_registry.csv"
)
duplicate_registry <- relocate_stage2_registry_paths(
  duplicate_registry, "metadata/stage2/screening/ds06_smhi_shark_duplicate_resolution_registry.csv"
)
...
write_csv_atomic(summary, "metadata/stage2/screening/ds06_smhi_shark_screening_summary.csv")
