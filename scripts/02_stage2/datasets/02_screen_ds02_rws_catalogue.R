...
pin <- utils::read.csv("metadata/stage2/acquisition/ds02_rws_catalogue_active_run.csv",
                       stringsAsFactors = FALSE, check.names = FALSE)
manifest <- utils::read.csv("metadata/stage2/acquisition/ds02_rws_catalogue_acquisition_manifest.csv",
                            stringsAsFactors = FALSE, check.names = FALSE)
access <- utils::read.csv("metadata/stage2/acquisition/ds02_rws_v3_access_diagnosis.csv",
                          stringsAsFactors = FALSE, check.names = FALSE)
access_pin <- utils::read.csv("metadata/stage2/acquisition/ds02_rws_v3_access_active_run.csv",
                              stringsAsFactors = FALSE, check.names = FALSE)
...
metadata_path <- "metadata/stage2/screening/ds02_rws_catalogue_metadata.csv"
location_path <- "metadata/stage2/screening/ds02_rws_catalogue_location_screen.csv"
link_summary_path <- "metadata/stage2/screening/ds02_rws_catalogue_link_summary.csv"

registry_path <- "metadata/stage2/screening/ds02_rws_catalogue_output_registry.csv"
