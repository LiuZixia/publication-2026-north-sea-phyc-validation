...
pin <- utils::read.csv("metadata/stage2/acquisition/ds26_smhi_ifcb_active_run.csv",
                       stringsAsFactors = FALSE, check.names = FALSE)
manifest <- utils::read.csv("metadata/stage2/acquisition/ds26_smhi_ifcb_acquisition_manifest.csv",
                            stringsAsFactors = FALSE, check.names = FALSE)
...
inventory_path <- "metadata/stage2/screening/ds26_smhi_ifcb_variable_inventory.csv"
table_summary_path <- "metadata/stage2/screening/ds26_smhi_ifcb_table_summary.csv"
measurement_summary_path <- "metadata/stage2/screening/ds26_smhi_ifcb_measurement_summary.csv"
event_summary_path <- "metadata/stage2/screening/ds26_smhi_ifcb_event_summary.csv"
event_linkage_path <- "metadata/stage2/screening/ds26_smhi_ifcb_event_linkage_audit.csv"
screening_path <- "data/interim/stage2_ds26_smhi_ifcb_record_screening.csv"
dataset_summary_path <- "metadata/stage2/screening/ds26_smhi_ifcb_screening_summary.csv"
registry_path <- "metadata/stage2/screening/ds26_smhi_ifcb_output_registry.csv"
