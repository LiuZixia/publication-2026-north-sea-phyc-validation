...
summary_path <- "metadata/stage2/screening/ds06_smhi_shark_duplicate_resolution_summary.csv"
overlap_path <- "metadata/stage2/screening/ds06_smhi_shark_sample_overlap.csv"
...
registry_path <- "metadata/stage2/screening/ds06_smhi_shark_duplicate_resolution_registry.csv"
