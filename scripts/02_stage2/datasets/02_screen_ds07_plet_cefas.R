...
pin <- utils::read.csv("metadata/stage2/acquisition/ds07_plet_cefas_active_run.csv",
...
summary_path <- "metadata/stage2/screening/ds07_plet_cefas_location_summary.csv"
