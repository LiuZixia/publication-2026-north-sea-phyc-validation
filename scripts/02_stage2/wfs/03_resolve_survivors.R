...
pin <- utils::read.csv("metadata/stage2/acquisition/emodnet_wfs_metadata_active_run.csv",
...
evidence <- utils::read.csv("metadata/stage2/screening/emodnet_wfs_geometry_evidence.csv",
                            stringsAsFactors = FALSE, check.names = FALSE,
                            colClasses = c(wfs_dataset_id = "character"))
screened <- utils::read.csv("metadata/stage2/screening/emodnet_wfs_screening.csv",
                            stringsAsFactors = FALSE, check.names = FALSE,
                            colClasses = c(wfs_dataset_id = "character"))
...
write_csv_atomic(resolution, "metadata/stage2/screening/emodnet_wfs_survivor_resolution.csv")
