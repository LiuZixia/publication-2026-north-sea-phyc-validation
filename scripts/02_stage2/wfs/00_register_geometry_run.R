...
if (length(arguments) != 1L) {
  stop("Usage: Rscript scripts/02_stage2/wfs/00_register_geometry_run.R data/raw/stage2/emodnet_wfs_geometry/<UTC>", call. = FALSE)
}
...
write_csv_atomic(pin, "metadata/stage2/acquisition/emodnet_wfs_active_run.csv")
