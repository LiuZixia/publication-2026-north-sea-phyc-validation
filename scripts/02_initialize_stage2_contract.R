...
shortlist_path <- "metadata/stage1_acquisition_shortlist.csv"
wfs_overlap_path <- "metadata/stage1_emodnet_wfs_overlap.csv"
registry_path <- "metadata/candidate_registry.csv"
work_order_path <- "metadata/stage2_acquisition_work_order.csv"
wfs_queue_path <- "metadata/stage2_wfs_geometry_queue.csv"
freeze_path <- "metadata/stage2_contract_freeze.json"
