...
See [docs/CONTEXT.md](docs/CONTEXT.md), [docs/DATASET_SYSTEMATIC_SEARCH.md](docs/DATASET_SYSTEMATIC_SEARCH.md), and [docs/OUTCOME_AND_LIFEFORM_PROTOCOL.md](docs/OUTCOME_AND_LIFEFORM_PROTOCOL.md).
