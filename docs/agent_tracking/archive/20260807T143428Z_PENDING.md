...
- **Carried forward after milestone snapshot:** `20260807T124500Z`
...
- GitHub CLI `gh` is not installed, so the previously requested GitHub publishing workflow remains blocked under the repository publishing procedure.
