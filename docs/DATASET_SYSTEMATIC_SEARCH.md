...
The recurrent archive contains 17,731 event rows, 121,103 machine-classified occurrence rows, and 1,111,062 extended measurement/fact rows. It reports occurrence-linked abundance, biovolume concentration, carbon content, classifier identity, classifier F1 score, and trophic type, plus event-level unidentified-ROI abundance/volume and instrument metadata. Exact frozen-geometry screening retains 3,212 core-domain occurrences and 57,844 in the external-transfer region; 60,047 Baltic or other rows are outside the domain and no occurrence lacks a valid coordinate. Generated evidence is in [`metadata/stage2_ds26_smhi_ifcb_event_summary.csv`](../metadata/stage2_ds26_smhi_ifcb_event_summary.csv), [`metadata/stage2_ds26_smhi_ifcb_measurement_summary.csv`](../metadata/stage2_ds26_smhi_ifcb_measurement_summary.csv), and [`metadata/stage2_ds26_smhi_ifcb_screening_summary.csv`](../metadata/stage2_ds26_smhi_ifcb_screening_summary.csv).
